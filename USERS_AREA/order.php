...
if (isset($_GET['user_id'])) {
    ...
    $result_cart_price = mysqli_query($_con, $cart_query_price);
    ...
    while ($row_price = mysqli_fetch_array($result_cart_price)) {
        ...
        $run_price = mysqli_query($_con, $select_product);
    ...
    $run_cart = mysqli_query($_con, $get_cart);
...
($user_id, $subtotal, $invoice_number, $count_products, NOW(), '$status')";
    $result_query = mysqli_query($_con, $insert_orders);
    if ($result_query) {
